...
def main(argv: List[str]) -> int:
    ...
    p.add_argument("--xfade", type=float, default=1.0, help="Transition duration seconds")
    p.add_argument("--align", type=str, choices=["end","midpoint"], default="end", help="Align transition end or midpoint to beat")
